...
```javascript
import isReadWriteProperty from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-read-write-property@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-read-write-property/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/assert-is-read-write-property/actions/workflows/test.yml?query=branch:v0.1.1
