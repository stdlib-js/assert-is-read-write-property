...
```javascript
isReadWriteProperty = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-read-write-property@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-read-write-property@v0.2.3-umd/browser.js"></script>
```
